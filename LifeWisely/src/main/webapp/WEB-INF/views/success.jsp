...
<<<<<<< HEAD
	<div align="center">
		<a href="/LifeWisely/login"> <img align="middle"
			style="width: auto; height: auto; max-width: 200px; max-height: 200px"
			src="http://www.colorado.edu/libraries/profiles/express/themes/expressbase/images/cu-logo.svg">
		</a>
	</div>
	<div align="center">

		<h2 style="float: left">Welcome ${UserName} (Gained: ${myRewards})</h2>
		<h4 style="float: right">
			<a href="/LifeWisely/logout">Logout</a>
		</h4>
		<h4 class="text-center">
			<a href="/LifeWisely/CreateReminder">Create Reminder</a>
		</h4>
		<h4 class="text-center">
			<a href="/LifeWisely/CreateGroup">Create Group</a>
		</h4>
	</div>
	<div align="center">
			...
			<table border="1">
				...
				<c:forEach items="${allReminders}" var="reminder">
					<tr>
						...
						<td><a
							href="/LifeWisely/EditReminder?getId=${reminder.getID()}">Edit</a></td>
						<td><a
							href="/LifeWisely/DeleteReminder?getId=${reminder.getID()}">Delete</a></td>
					</tr>
				</c:forEach>
			</table>
		</c:if>
			...
			<table border="1">
				...
				<c:forEach items="${allGroupReminders}" var="reminder">
					<tr>
						...
						<td><a
							href="/LifeWisely/LeaveGroup?getId=${reminder.getId()}">Leave</a></td>
					</tr>
					</tr>
				</c:forEach>
